    ...
    return (
        <>
            <div id="webgl" style={{ position: "absolute", width: "100%", height: "100%" }}>
                <Process data={props.data} imageUrl={props.imageUrl} geometry={props.geometry} surface={props.surface} light={props.light} animation={props.animation} model={props.model} />
